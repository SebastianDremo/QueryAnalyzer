// Generated from C:/Users/sebas/Projects/QueryAnalyzer/QueryAnalyzer/QueryAnalyzer.Parser/Grammars\TSqlLexer.g4 by ANTLR 4.10.1
...
public class TSqlLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"GENERATED", "ALWAYS", "NEVER", "ALLOW_SINGLE_EVENT_LOSS", "ANONYMOUS", 
			"APPEND", "APPLICATION", "ASYMMETRIC", "ASYNCHRONOUS_COMMIT", "AUTHENTICATE", 
			"AUTHENTICATION", "AUTOMATED_BACKUP_PREFERENCE", "AUTOMATIC", "AVAILABILITY_MODE", 
			"BEFORE", "BLOCK", "BLOCKERS", "BLOCKSIZE", "BLOCKING_HIERARCHY", "BUFFER", 
			"BUFFERCOUNT", "CACHE", "CALLED", "CERTIFICATE", "CHANGETABLE", "CHANGES", 
			"CHECK_POLICY", "CHECK_EXPIRATION", "CLASSIFIER_FUNCTION", "CLUSTER", 
			"COMPRESSION", "CONNECT", "CONNECTION", "CONFIGURATION", "CONTAINMENT", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'OPTIMIZE'", "'OUT'", "'OUTPUT'", "'OVERRIDE'", "'OWNER'", "'PAGE_VERIFY'", 
			"'PARAMETERIZATION'", "'PARTITION'", "'PARTITIONS'", "'PARTNER'", "'PATH'", 
			"'PERCENT_RANK'", "'PERCENTILE_CONT'", "'PERCENTILE_DISC'", "'POISON_MESSAGE_HANDLING'", 
			...
			"'SUBSCRIBE'", "'SUBSCRIPTION'", "'SUM'", "'SUSPEND'", "'SYMMETRIC'", 
			...
			"'XSINIL'", "'ZONE'", "'$ACTION'", "'ABORT_AFTER_WAIT'", "'ABSENT'", 
			"'ADMINISTER'", "'AES'", "'ALLOW_CONNECTIONS'", "'ALLOW_MULTIPLE_EVENT_LOSS'", 
			"'GENERATED'", "'ALWAYS'", "'NEVER'", "'ALLOW_SINGLE_EVENT_LOSS'", "'ANONYMOUS'", 
			...
			"'LISTENER_PORT'", "'LOCAL_SERVICE_NAME'", "'LOG'", "'MASK'", "'MASKED'", 
			...
			"'MEMBER'", "'MEMORY_PARTITION_MODE'", "'MESSAGE_FORWARDING'", "'MESSAGE_FORWARD_SIZE'", 
			"'MINVALUE'", "'MIRROR'", "'MUST_CHANGE'", "'NOFORMAT'", "'NOINIT'", 
			...
			"'RESOURCES'", "'RESTART'", "'RESUME'", "'RETAINDAYS'", "'RETURNS'", 
			"'REWIND'", "'ROLE'", "'ROUND_ROBIN'", "'RSA_512'", "'RSA_1024'", "'RSA_2048'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"CHECK_EXPIRATION", "CLASSIFIER_FUNCTION", "CLUSTER", "COMPRESSION", 
			"CONNECT", "CONNECTION", "CONFIGURATION", "CONTAINMENT", "CONTEXT", "CONTINUE_AFTER_ERROR", 
